...
export default function Task({ taskId, folderId, text, completed, isFetching, changeTaskText, changeTaskState, removeTask }) {
    ...
    const onChangeTask = () => {
        if(!isEmpty(currentValue)){
            changeTaskText({taskId, text: currentValue}, cancelInput);
        };
    };

    const onChangeCheckbox = event => {
        changeTaskState(taskId, event.target.checked);
    };
    ...
    return (
        <div className={style.tasks__item}>
            ...
            {!editMode &&
                <>
                    <span>{text}</span>
                    <div className={style.tasks__items_actions}>
                        <div 
                        ...
                        <div 
                            onClick={() => removeTask(taskId, folderId)}
                        >
